...
def show_ldif():
    ...
    # http://stackoverflow.com/questions/6920302/passing-argument-in-python-ttkinter-button-command
...
w.grid(row=7,column=1, sticky="ew", padx=3)
